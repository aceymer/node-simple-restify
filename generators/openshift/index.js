...
module.exports = generators.Base.extend({
  ...
  initializing: function () {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath('dist/.openshift/')
    );
    this.fs.copyTpl(
      this.templatePath('deplist.txt'),
      this.destinationPath('dist/deplist.txt')
    );
    this.fs.copyTpl(
      this.templatePath('LICENSE'),
      this.destinationPath('dist/LICENSE')
    );
    this.fs.copyTpl(
      this.templatePath('README'),
      this.destinationPath('dist/README')
    );
    this.fs.copyTpl(
...
//   if(this.abort || !this.openshift_remote_exists ) return;
//   var done = this.async();
//   this.log(chalk.bold("\nEnabling HotDeploy and adding new version for OpenShift"));
//   //this.copy('hot_deploy', 'dist/.openshift/markers/hot_deploy');
//   this.fs.directory('.openshift', 'dist/.openshift');
//   this.fs.copy('deplist.txt', 'dist/deplist.txt');
//   this.fs.copy('LICENSE', 'dist/LICENSE');
//   this.fs.copy('README', 'dist/README');
//   this.fs.copy('README.md', 'dist/README.md');
